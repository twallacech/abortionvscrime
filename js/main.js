...
function setMap(){
    ...
    queue()
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/grades.csv")
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/prohibitedAfter.csv")
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/counseling.csv")
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/waitingPeriod.csv")
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/consent.csv")
        .defer(d3.csv, "/twallacech95/twallacech95.github.io/data/ultrasound.csv")
        .defer(d3.json, "/twallacech95/twallacech95.github.io/data/usa.topojson")
        .defer(d3.json, "/twallacech95/twallacech95.github.io/data/CPCs.geojson")
        .defer(d3.json, "/twallacech95/twallacech95.github.io/data/AbortionProviders.geojson")
        .await(callback);
